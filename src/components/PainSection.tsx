    ...
    <section className="relative section-spacing overflow-hidden">
      ...
      <div className="container mx-auto px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <h2 className="text-3xl md:text-4xl font-light tracking-tighter-custom text-gradient mb-12 heading-tight">
          ...
          <div className="glass-card p-8 md:p-12">
            <ul className="space-y-6">
              {painPoints.map((point, index) => (
                <li key={index} className="flex items-start gap-4 text-lg md:text-xl text-foreground/80 font-light leading-relaxed">
            ...
            <div className="mt-12 pt-10 border-t border-border/30">
              <p className="text-2xl md:text-3xl font-light text-foreground/90 tracking-tight-custom heading-tight">
                Mucho movimiento.<br />
                Poco margen.<br />
