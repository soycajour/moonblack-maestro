    ...
    <section className="relative section-spacing">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="max-w-4xl mb-16">
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-light tracking-tighter-custom text-gradient mb-6 heading-tight">
            El nuevo modelo de captación para contratistas de techado en República Dominicana
          </h2>
          <p className="text-2xl md:text-3xl font-light text-foreground/80 mb-2 heading-tight">
            No hacemos páginas bonitas.
          </p>
          <p className="text-2xl md:text-3xl font-light text-foreground/80 heading-tight">
            Instalamos{" "}
        ...
        <div className="max-w-3xl">
          <p className="text-muted-foreground mb-8 text-lg font-light">Un sistema que:</p>
          <div className="glass-card p-8 md:p-10">
            <ul className="space-y-5">
              {systemPoints.map((point, index) => (
                <li key={index} className="flex items-start gap-4 text-foreground/80 font-light leading-relaxed">
          ...
          {/* Closing */}
          <div className="mt-12">
            <p className="text-xl md:text-2xl font-light text-foreground/70 heading-tight">
              No es marketing tradicional.
            </p>
            <p className="text-xl md:text-2xl font-light text-primary mt-2 heading-tight">
